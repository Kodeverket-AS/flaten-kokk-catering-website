        ...
        sections={[
          {
            ...
            description:
              "Fra klassiske norske kjøkken til internasjonale restauranter",
          ...
          },
          {
            ...
            description:
              "Fra intime middager til store bryllup og firmaarrangementer",
            icon: "/icons/lucide_users.svg",
          },
          {
            title: "Lidenskap for råvarer",
            description:
              "Samarbeider med lokale produsenter for de beste ingrediensene",
      ...
      <Verdier
        items={[
          ...
          },
          {
            ...
            title: "Internasjonal erfaring",
            description:
              "Arbeidet på Michelin-stjernede restauranter i Frankrike og Italia",
          },
          {
            year: "2015",
          ...
          },
          {
            ...
            description:
              "Startet Flaten Kokk og Catering for å skape unike matopplevelser",
          },
          {
            year: "2023",
            title: "I dag",
            description:
              "Over 500 vellykkede arrangementer og voksende kundebase",
          },
        ]}
      />
