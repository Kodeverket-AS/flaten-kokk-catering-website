      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          {displayProducers.map((producer) => {
            ...
            const cardClasses = "flex flex-row md:flex-row lg:flex-col items-center bg-white rounded-[24px] overflow-hidden border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1";

            if (producer.link) {
              const isExternal = producer.link.startsWith('http://') || producer.link.startsWith('https://');
