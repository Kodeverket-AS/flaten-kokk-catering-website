...
export function Footer() {
  return (
    <footer className="w-full py-10 max-w-[1280px] mx-auto">
      <div className="flex flex-col justify-between md:flex-row gap-y-10 md:gap-x-1 px-6 md:px-4 xl:px-20">
        <div className="flex flex-col gap-2">
          ...
          <p className="sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-1xl">
            Profesjonell matlagning og catering-tjenester for alle anledninger.
            Vi skaper uforglemmelige matopplevelser som bringer mennesker
            sammen.
          </p>
