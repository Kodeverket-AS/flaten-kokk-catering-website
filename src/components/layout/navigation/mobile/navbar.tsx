          ...
          {pages.map((page) => {
            ...
            return (
              <li key={page.name}>
                <Link
                  href={page.path}
                  className={`px-3 py-2 rounded-lg transition-all duration-200 hover:text-amber-700 ${
                ...
                return (
                  <li key={page.name}>
                    <Link
                      ...
                      className={`block px-4 py-2 rounded-lg transition-all duration-200 hover:text-amber-500 active:text-amber-700 ${
                        isActive ? "text-amber-700" : ""
                      }`}
                    >
                      {page.name}
