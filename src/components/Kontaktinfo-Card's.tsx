  ...
  return (
    <div className="wrapper-component">
      <div className="flex flex-col justify-center items-start gap-4 w-fitt">
        <div className="Kontakt-info w-[308px] md:w-65 lg:w-[308px] p-6 sm:p-10 bg-stone-50 rounded-2xl border border-gray-200">
        ...
        <div className="Booking-info w-[308px] md:w-65 lg:w-[308px] p-6 sm:p-10 bg-stone-50 rounded-2xl border border-gray-200">
        ...
        <div className="Foretrekker-tlf w-[308px] md:w-65 lg:w-[308px] p-6 sm:p-10 bg-stone-50 rounded-2xl border border-gray-200 flex flex-col justify-center items-center">
